...
# Download the data, if it hasn't already been done.
if(!dir.exists("data/philawhite-spGDMM-code-d8279ee/data/")) {
  download_zenodo("10.5281/zenodo.10091441", path="data")
  unzip("data/spGDMM-code-spGDMM_v1.zip", exdir="data")
}

Data <- read.csv("data/philawhite-spGDMM-code-d8279ee/data/sa_species_data.csv")
